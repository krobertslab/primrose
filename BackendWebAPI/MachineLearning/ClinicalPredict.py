...
def clean_text(text):
    genes = parsegene("/Users/samshenoi/Documents/CPRIT/CPRIT/MachineLearning/Topics/topics2018.xml")
    ## Remove puncuation
    text = str(text)
...
x_train, y_train = load_svmlight_file("/Users/samshenoi/Documents/CPRIT/CPRIT/MachineLearning/data/clinicaltrain.txt")
x_valid, y_valid = load_svmlight_file("/Users/samshenoi/Documents/CPRIT/CPRIT/MachineLearning/data/clinicalval.txt")
q_train = np.loadtxt('/Users/samshenoi/Documents/CPRIT/CPRIT/MachineLearning/data/clinicaltrain.group')
q_valid = np.loadtxt('/Users/samshenoi/Documents/CPRIT/CPRIT/MachineLearning/data/clinicalval.group')
