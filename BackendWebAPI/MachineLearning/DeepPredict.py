...
# load json and create model
def load_trained_model():
    json_file = open('/Users/samshenoi/Documents/CPRIT/CPRIT/MachineLearning/Models/model_conv.json', 'r')
    loaded_model_json = json_file.read()
    json_file.close()
    loaded_model = model_from_json(loaded_model_json)
    # load weights into new model
    loaded_model.load_weights("/Users/samshenoi/Documents/CPRIT/CPRIT/MachineLearning/Weights/model_conv.h5")
    print("Loaded model from disk")
