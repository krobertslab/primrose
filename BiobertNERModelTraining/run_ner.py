...
class NerProcessor(DataProcessor):
    ...
    def get_labels(self):
        return ["I-Outcome", "B-N-Population", "I-N-Population", "L-N-Population", "L-Treatment", "L-N-Treatment", "B-N-Cancer", "I-N-Cancer", "U-N-Treatment", "U-N-Cancer", "U-N-Mutation", "L-N-Cancer", "-",'"',"[PAD]", "B", "I", "O", "X", "[CLS]", 'B-N-Treatment', "[SEP]", "B-Cancer", "B-Mutation", "B-Treatment", "B-Population", "B-Outcome", "I-Cancer", "I-Mutation", "I-Treatment", "I-Population", "B-N-Mutation", "I-N-Mutation", "L-N-Mutation", "I-Outcome","L-Cancer", "L-Mutation", "B-N-Treatment" "L-Treatment", "L-Population", "L-Outcome","U-Cancer", "U-Mutation", "U-Treatment", "U-Population", "U-Outcome", "O", "I-N-Treatment"] 
...
def main(_):
    ...
    if FLAGS.do_train:
        ...
        #print("length of train examples:")
